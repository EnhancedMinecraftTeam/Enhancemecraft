...
public class EntityNetherMen extends EntityMob
{
    ...
    public EntityNetherMen(World par1World)
    {
        super(par1World);
    ...
    {
        return this.isScreaming() ? "mob.endermen.scream" : "mob.zombiepig.zpighurt";
    }
