...
public class clientFusionFurnace extends GuiContainer {

	private tileFusionFurnace furnaceInventory;

    private static final ResourceLocation field_110410_t = new ResourceLocation(libInfo.ID + ":" + "textures/gui/fusionFurnance.png");
	
    public clientFusionFurnace(InventoryPlayer par1InventoryPlayer, tileFusionFurnace par2TileEntityFurnace)
    {
