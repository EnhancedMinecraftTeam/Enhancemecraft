...
public class containerFusionFurnace extends Container {
	...
	private tileFusionFurnace furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;
	
    public containerFusionFurnace(InventoryPlayer par1InventoryPlayer, tileFusionFurnace par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 79, 34)); //Output
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (tileFusionFurnace.isItemFuel(itemstack1))
                {
